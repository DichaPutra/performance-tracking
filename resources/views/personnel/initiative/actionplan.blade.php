        ...
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card shadow mb-4 animated--grow-in">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center">
                    <a href="{{route('personnel.initiative.kpi', ['idpersonnel'=>$data->id,'tahun'=>$tahun,'idkpi'=>$datakpiselected->id])}}" style="margin-right: 15px;"class="btn btn-sm btn-primary "><i class="fas fa-chevron-left"></i></a><br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; width: 10%">
                                                <form method="post" action="{{route('personnel.initiative.deleteactionplan')}}">
                                                    @csrf
                                                    <input name="id_user"type="hidden" value="{{$data->id}}">
                                                    <input name="id_target_si"type="hidden" value="{{$datasi->id}}">
                                                    <input name="tahun"type="hidden" value="{{$tahun}}">
