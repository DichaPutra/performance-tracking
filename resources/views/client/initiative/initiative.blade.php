    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card shadow mb-4 animated--grow-in">
                ...
                <div
                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Initiative</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{route('client.initiative.actionplan')}}"><button class="btn btn-primary btn-sm">Details</button></a></td>
                                </tr>
                                <tr>
