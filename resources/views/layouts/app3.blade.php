...
<?php
// untuk mengambil notifikasi chat
use App\Models\ChMessage;

function getCountNotification($id_user)
{
    $getCountNotification = ChMessage::where('to_id', $id_user)
        ->where('seen', 0)
        ->count();
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}"
                ...
                <div class="sidebar-brand-text" style="font-size: small;text-align: left;"><b>Performance</b><br>
                    <h5>Tracking</h5>
                </div>
            </a>
    ...
    <a href="{{ route('chatify') }}" class="float" target="_blank">
        ...
        @if (getCountNotification(Auth::user()->id) > 0)
            <span class="icon-button__badge">{{ getCountNotification(Auth::user()->id) }}</span>
        @endif
    </a>
