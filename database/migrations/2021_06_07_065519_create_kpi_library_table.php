    ...
    public function up() {
        ...
        DB::table('kpi_library')->insert(
                [
                    ...
                    ['id_so_library' => '7', 'kpi' => 'Pendapatan per SDM','unit' => '%', 'measurement' => 'percentages' ,'polarization' => 'maximize'],
                    ['id_so_library' => '7', 'kpi' => 'Biaya Per SDM','unit' => '%', 'measurement' => 'percentages' ,'polarization' => 'minimize'],
